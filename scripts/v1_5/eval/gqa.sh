...
output_file=${GQADIR}/answers/${CKPT}/${METHOD}/${PARAM}/merge.jsonl
...
cd $GQADIR
python eval.py --tier testdev_balanced --predict ${CKPT}/${METHOD}/${PARAM}/testdev_balanced_predictions.json
